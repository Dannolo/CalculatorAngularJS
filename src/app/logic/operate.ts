...
// Classic math operations, we transform the state.total and state.next we get to number so we can do math operations
// and we report them back to string in the end.
